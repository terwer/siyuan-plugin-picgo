...
const config = (ctx: IPicGo): IPluginConfig[] => {
  ...
  const config: IPluginConfig[] = [
    ...
    },
    {
      ...
      required: false,
      get prefix () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_CUSTOM_URL') },
      get alias () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_CUSTOM_URL') },
      get message () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_MESSAGE_CUSTOM_URL') },
    },
    {
    ...
    },
    {
      ...
      required: false,
      get prefix () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_CORS_PROXY') },
      get alias () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_CORS_PROXY') },
      get message () { return ctx.i18n.translate<ILocalesKey>('PICBED_AWSS3PLIST_MESSAGE_CORS_PROXY') },
    },
  ]
  return config
}
